...
<center>
    <main>
        <section class="intro" style="padding-bottom: 5%">
            <p class="headline">Serie | Kornblume</p>
            <br>
            <p>
        ...
        <section class="serie">
                    ...
                    <div class="box">
                        ...
                        <div class="box-text">
                            ...
                            <form method="post">
                                ...
                                <input type="submit" name="basket-Einladung">
                    ...
                    <div class="box">
                        ...
                        <div class="box-text">
                            ...
                            <form method="post">
                                ...
                                <input type="submit" name="basket-StD">
                    ...
                    <div class="box">
                        ...
                        <div class="box-text">
                            ...
                            <form method="post">
                                ...
                                <input type="submit" name="basket-Kirchenheft">
                    ...
                    <div class="box">
                        ...
                        <div class="box-text">
                            ...
                            <form method="post">
                                ...
                                <input type="submit" name="basket-Rück">
                    ...
                    <div class="box">
                        ...
                        <div class="box-text">
                            ...
                            <form method="post">
                                ...
                                <input type="submit" name="basket-Menü">
            ...
            <div class="row" id="Dankeskarte">
                ...
                <div class="column column-50 flex-columns">
                    <?php
                    $article_number = "1.6";
                    $article = "Dankeskarte | Serie Kornblume";
                    $image = "../img/Muttertagskarte.JPEG";
                    $price = 2.50;
                    ?>
                    <div class="box">
                        ...
                        <div class="box-text">
                            ...
                            <form method="post">
                                ...
                                <input type="submit" name="basket-Danke">
            ...
            <div class="row" id="Briefumschlag">
                ...
                <div class="column column-50 flex-columns">
                    <?php
                    $article_number = "1.6";
                    $article = "Briefumschläge | Serie Kornblume";
                    $image = "../img/Muttertagskarte.JPEG";
                    $price = 2.50;
                    ?>
                    <div class="box">
                        ...
                        <div class="box-text">
                            ...
                            <form method="post">
                                ...
                                <input type="submit" name="basket-Umschlag">
